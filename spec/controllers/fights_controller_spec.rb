...
describe FightsController do
  ...
  let(:valid_attributes) { { "winner_id" => "1" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved fight as @fight" do
        ...
        post :create, {:fight => { "winner_id" => "invalid value" }}, valid_session
        assigns(:fight).should be_a_new(Fight)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested fight" do
        ...
        Fight.any_instance.should_receive(:update).with({ "winner_id" => "1" })
        put :update, {:id => fight.to_param, :fight => { "winner_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the fight as @fight" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Fight.any_instance.stub(:save).and_return(false)
        put :update, {:id => fight.to_param, :fight => { "winner_id" => "invalid value" }}, valid_session
        assigns(:fight).should eq(fight)
      end
